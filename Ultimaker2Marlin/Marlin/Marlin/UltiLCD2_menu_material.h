...
#define FILAMENT_PRE_RETRACT_FORWARD_LENGTH   50.0  //20.0// before retract, we first forward a little to retract more easily
#define FILAMENT_REVERSAL_SPEED       60 //100
#define FILAMENT_LONG_MOVE_ACCELERATION 25 //30
...
#define FILAMENT_INSERT_FAST_SPEED    60 //100   //Speed during the forward length
